...
PowerShell demo:  $cs = 'DEFCAM', 'LEPTON35', 'OV9281'; $cs | ForEach-Object {.\\pythpath.ps1 312 ./ThreeCams.py $_}
'''
...
def set_up_camera(camera_index):
    ...
    cap.set(cv2.CAP_PROP_EXPOSURE, -7) #- useful for those who hunt for antialiasing (or are haunted by...)
    return cap
...
def main():
    ...
    try:
        ...
        while True:
            ...
            # ...
            # ... and show it off!
            cv2.imshow(f'{camera.name}@{frame.shape}', frame)
